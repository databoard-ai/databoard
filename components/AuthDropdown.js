const AuthDropdown = ({inpName, title, options}) => {
    return(
        <div className='ml-[88px] mb-[24px]'>
            ...
            <select className="w-[360px] h-[60px] p-[10px] rounded-[8px] border border-opacity-[0.3] border-[#121212] text-[#121212] text-opacity-[0.7]" name={inpName} placeholder={title}>
