                ...
                <div className='content mt-12 grid xsm:grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-12'>
                    <div className='blog-item ring-1 ring-[#C3C3C3] rounded-sm cursor-pointer'>
                        ...
                        <div className='mt-5 px-2'>
                            ...
                            <span className='block text-[18px] font-semibold mt-5'>Welcome! Getting started with Databoard</span>
                    ...
                    <div className='blog-item ring-1 ring-[#C3C3C3] rounded-sm cursor-pointer'>
                        ...
                        <div className='mt-5 px-2'>
                            ...
                            <span className='block text-[18px] font-semibold mt-5'>Data Culture in Africa - The Past the Present and the Databoard</span>
                    ...
                    <div className='blog-item ring-1 ring-[#C3C3C3] rounded-sm cursor-pointer'>
                        ...
                        <div className='mt-5 px-2'>
                            ...
                            <span className='block text-[18px] font-semibold mt-5'>The Use of Data in personalized marketing, and its impact on Customer Engagement</span>
                    ...
                    <div className='blog-item ring-1 ring-[#C3C3C3] rounded-sm cursor-pointer'>
                        ...
                        <div className='mt-5 px-2'>
                            ...
                            <span className='block text-[18px] font-semibold mt-5'>Thinking Data in an Emerging Economy</span>
                    ...
                    <div className='blog-item ring-1 ring-[#C3C3C3] rounded-sm cursor-pointer'>
                        ...
                        <div className='mt-5 px-2'>
                            ...
                            <span className='block text-[18px] font-semibold mt-5'>How Data helps Businesses save Time and become more Efficient</span>
                    ...
                    <div className='blog-item ring-1 ring-[#C3C3C3] rounded-sm cursor-pointer'>
                        ...
                        <div className='mt-5 px-2'>
                            ...
                            <span className='block text-[18px] font-semibold mt-5'>Consumer Data: Little is Much</span>
                    ...
                    <div className='blog-item ring-1 ring-[#C3C3C3] rounded-sm cursor-pointer'>
                        ...
                        <div className='mt-5 px-2'>
                            ...
                            <span className='block text-[18px] font-semibold mt-5'>The Challenges and Limitation of Data analysis, and how to Overcome Them</span>
                    ...
                    <div className='blog-item ring-1 ring-[#C3C3C3] rounded-sm cursor-pointer'>
                        ...
                        <div className='mt-5 px-2'>
                            ...
                            <span className='block text-[18px] font-semibold mt-5'>The Role of Data Governance in ensuring the Quality and Integrity of your Data</span>
